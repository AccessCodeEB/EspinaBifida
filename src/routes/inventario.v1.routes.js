 ...
 *     tags:
 *       - Inventario v1
 *     summary: Resumen del inventario actual (v1)
 *     description: >
 *       Devuelve el stock actual de todos los artículos en la versión estable v1.
 *       Con `?alertas=true` filtra únicamente los artículos con stock bajo el umbral mínimo.
 *     operationId: getInventarioV1
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *     tags:
 *       - Inventario v1
 *     summary: Historial de movimientos de inventario (v1)
 *     description: >
 *       Devuelve el historial paginado de movimientos ENTRADA/SALIDA del inventario
 *       en la versión estable v1. Permite filtrar por artículo, tipo y rango de fechas.
 *     operationId: getMovimientosInventarioV1
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *     tags:
 *       - Inventario v1
 *     summary: Registrar movimiento de inventario (v1)
 *     description: >
 *       Crea un nuevo movimiento ENTRADA o SALIDA en el inventario bajo la versión estable v1.
 ...
 *     operationId: createMovimientoInventarioV1
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 *       required: true
