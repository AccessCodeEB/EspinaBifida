 ...
 *     operationId: syncEstadosMembresias
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 *       required: false
 ...
 *     operationId: validarMembresiaActiva
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     operationId: getMembresiasByCurp
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
